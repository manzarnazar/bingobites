...
class OrderController extends Controller
{
    ...
    public function editOrder(Request $request, $orderId)
    {
        ...
        return response()->json([
            'success' => true,
            'view' => view('admin-views.order.partials.order-products-table', compact('orderProducts', 'orderId'))->render(),
        ]);
...
//        ]);
    ...
    public function loadVariationModal(Request $request)
    {
        ...
        return response()->json([
            'success' => true,
            'html' => view('admin-views.order.partials.variation-product-modal', compact('product', 'productData', 'branchId', 'orderId'))->render()
        ]);
    }
