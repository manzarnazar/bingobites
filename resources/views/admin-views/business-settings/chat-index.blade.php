                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.third-party.chat-update',['whatsapp']):'javascript:'}}"
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <label class="switcher cmn_focus-shadow rounded-pill">
                                        <input class="switcher_input" name="status" type="checkbox" tabindex="1" {{$config['status'] == 1? 'checked' : ''}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="number"
                                           value="{{$config['number'] ?? ''}}" placeholder="{{ translate('WhatsApp Number') }}" tabindex="2">
                                </div>
                                <div class="btn--container">
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            class="btn btn-primary mb-2 call-demo" tabindex="3">{{translate('save')}}
                                    </button>
                                </div>
