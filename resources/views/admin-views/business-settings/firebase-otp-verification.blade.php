                            ...
                            <div class="row">
                                <div class="col-md-6 pt-5">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px cmn_focus toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                            ...
                                            <input type="checkbox" class="toggle-switch-input" name="status" tabindex="2" {{ isset($firebaseOTP) && $firebaseOTP['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" value="{{$firebaseOTP && env('APP_MODE')!='demo' ? $firebaseOTP['web_api_key'] : ''}}" name="web_api_key" class="form-control" placeholder="" tabindex="3">
                                    </div>
                                </div>
                            </div>
                            <div class="btn--container justify-content-end">
                                <button type="reset" class="btn btn-secondary" tabindex="4">{{translate('clear')}}</button>
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        class="btn btn-primary call-demo" tabindex="5">{{translate('submit')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
