            ...
            <div class="card">
                <form id="login-setup-form" action="{{route('admin.business-settings.restaurant.login-setup-update')}}" method="post">
                        ...
                        <div class="login-option mt-2 mb-5">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 mb-2">
                                    <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                        ...
                                        <input name="manual_login" class="rounded" type="checkbox" tabindex="1"
                                ...
                                <div class="col-lg-4 col-sm-6 mb-2">
                                    <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                        ...
                                        <input name="otp_login" class="rounded" type="checkbox" tabindex="2"
                                ...
                                <div class="col-lg-4 col-sm-6 mb-2">
                                    <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                        ...
                                        <input name="social_media_login" class="rounded" type="checkbox" tabindex="3"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="google" class="rounded" type="checkbox" tabindex="4"
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="facebook" class="rounded" type="checkbox" tabindex="5"
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="apple" class="rounded" type="checkbox" tabindex="6"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="email_verification" class="rounded" type="checkbox" tabindex="7"
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex cmn_focus justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="phone_verification" class="rounded" type="checkbox" tabindex="8"
                    ...
                    <div class="btn--container mb-4 mx-4">
                        <button type="reset" class="btn btn-secondary" tabindex="9">{{translate('reset')}}</button>
                        <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                class="btn btn-primary call-demo" tabindex="10">{{translate('submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
