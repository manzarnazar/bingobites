    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('assets/admin/img/icons/social.png')}}" alt="">
                ...
                <form>
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <select class="custom-select" name="name" id="name" tabindex="1">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="link" class="form-control" id="link"
                                    placeholder="{{translate('Enter Social Media Link')}}" required tabindex="2">
                        </div>
                        ...
                        <div class="col-12">
                            <div class="btn--container">
                                <button type="reset" class="btn btn-secondary" tabindex="3">{{translate('reset')}}</button>
                                <button type="button" id="add" class="btn btn-primary" tabindex="4">{{ translate('save')}}</button>
                                <button type="button" id="update" class="btn btn-primary" tabindex="5" style="display: none">{{ translate('update')}}</button>
                                <!-- <a id="update" class="btn btn-primary" tabindex="5" style="display: none">{{ translate('update')}}</a> -->
                            </div>
                        </div>
                    </div>
                </form>
