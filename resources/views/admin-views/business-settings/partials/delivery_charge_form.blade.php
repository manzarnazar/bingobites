                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="bg-white rounded p-20">
                        <div class="form-group m-0">
                            ...
                            <div class="d-flex justify-content-between border cmn_focus rounded px-4 form-control">
                                ...
                                <label class="switcher ml-auto mb-0">
                                    <input type="checkbox" class="switcher_input @if($branch?->delivery_charge_setup?->free_delivery_over_status == 1) off-free-delivery-over-{{$branch->id}} @else on-free-delivery-over-{{$branch->id}} @endif"
                                           name="free_delivery_over_status" tabindex="1"
                            ...
                            <form action="{{ route('admin.business-settings.restaurant.store-free-delivery-over-amount') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="free_delivery_over_amount" min="0" max="9999999999" step="0.0001"
                                        value="{{ $branch?->delivery_charge_setup?->free_delivery_over_amount }}" id="free_delivery_over_amount" placeholder="Ex: 10" required tabindex="2">
                                </div>
                                <div class="d-flex justify-content-end gap-3 mt-4">
                                    <button type="reset" id="reset" class="btn btn-secondary" tabindex="3">{{translate('reset')}}</button>
                                    <button type="submit" class="btn btn-primary" tabindex="4">{{ translate('Save') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<div class="card mt-4">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border rounded px-3 py-3">
            ...
            <label class="switcher ml-auto mb-0 cmn_focus rounded-pill">
                <input type="checkbox" class="switcher_input change-delivery-charge-type-{{$branch->id}}" name="delivery_charge_type" tabindex="5"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="fixed_delivery_charge" min="0" max="99999999" step="0.0001"
                               value="{{ $branch?->delivery_charge_setup?->fixed_delivery_charge }}" id="fixed_delivery_charge" placeholder="Ex: 10" required tabindex="6">
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-end gap-3 mt-4">
                <button type="reset" id="reset" class="btn btn-secondary" tabindex="7">{{translate('reset')}}</button>
                <button type="submit" class="btn btn-primary" tabindex="8">{{ translate('Save') }}</button>
            </div>
        </form>
    </div>
</div>
...
<div class="card mt-4">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border rounded px-3 py-3">
            ...
            <label class="switcher ml-auto mb-0 cmn_focus rounded-pill">
                <input type="checkbox" class="switcher_input change-delivery-charge-type-{{$branch->id}}" name="delivery_charge_type" tabindex="9"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="delivery_charge_per_kilometer" min="0" max="99999999" step="0.0001"
                               value="{{ $branch?->delivery_charge_setup?->delivery_charge_per_kilometer }}" id="delivery_charge_per_kilometer" placeholder="Ex: 10" required tabindex="10">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="minimum_delivery_charge" min="0" max="99999999" step="0.0001"
                               value="{{ $branch?->delivery_charge_setup?->minimum_delivery_charge }}" id="minimum_delivery_charge" placeholder="Ex: 10" required tabindex="11">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="minimum_distance_for_free_delivery" min="0" max="99999999" step="0.0001"
                               value="{{ $branch?->delivery_charge_setup?->minimum_distance_for_free_delivery }}" id="minimum_distance_for_free_delivery" placeholder="Ex: 10" required tabindex="12">
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-end gap-3 mt-4">
                <button type="reset" id="reset" class="btn btn-secondary" tabindex="13">{{translate('reset')}}</button>
                <button type="submit" class="btn btn-primary" tabindex="14">{{ translate('Save') }}</button>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="d-flex justify-content-between align-items-center border rounded mb-2 px-3 py-3">
            ...
            <label class="switcher ml-auto mb-0 cmn_focus rounded-pill">
                <input type="checkbox" class="switcher_input @if($areaCount > 0) change-delivery-charge-type-{{$branch->id}} @else change-delivery-charge-to-area-{{$branch->id}} @endif"
                       name="delivery_charge_type" tabindex="15"
                        ...
                        <div class="card-top px-card pt-4">
                            <div class="d-flex flex-column flex-md-row flex-wrap gap-3 justify-content-md-between align-items-md-center">
                                <form action="{{url()->current()}}" method="GET">
                                    <div class="input-group">
                                        <input id="datatableSearch_" type="search" name="search" class="form-control min-width-300px"
                                               ...
                                               aria-label="Search" value="{{ request()->input('search') }}"  autocomplete="off" tabindex="16">
                                ...
                                <div class="d-flex flex-wrap justify-content-md-end gap-3">
                                    <div>
                                        <a type="button" class="btn btn-outline-primary text-nowrap cmn_focus"
                                           href="{{ route('admin.business-settings.restaurant.export-area-delivery-charge',[$branch->id]).  (request('search') ? '?search=' . request('search') : '') }}" tabindex="17">
                                            <i class="tio-upload"></i>
                                            {{ translate('Export') }}
                                        </a>
                                    </div>
                                    <div>
                                        <button type="button" class="btn btn-outline-primary cmn_focus text-nowrap" data-toggle="modal" data-target="#importConfirmModal-{{$branch->id}}" tabindex="18">
                                            <i class="tio-download-to"></i>
                                            {{ translate('Import') }}
                                        </button>
                                    </div>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAreaModal-{{$branch->id}}" data-id="{{$branch->id}}" tabindex="19">
                                        <i class="tio-add"></i>
