    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-between cmn_focus-shadow align-items-center border rounded mb-2 px-3 py-2">
                            <h5 class="mb-0">{{translate('Maintenance Mode')}}</h5>

                            <label class="switcher ml-auto mb-0 rounded-pill">
        ...
        <form action="{{route('admin.business-settings.restaurant.update-setup')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$restaurant_name}}"
                                       name="restaurant_name" class="form-control" placeholder="{{translate('Ex: ABC Company')}}" tabindex="2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$phone}}"
                                       name="phone" class="form-control" placeholder="{{translate('Ex: +9xxx-xxx-xxxx')}}" tabindex="3">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" value="{{$email}}"
                                       name="email" class="form-control" placeholder="{{translate('Ex: contact@company.com')}}" tabindex="4">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control" placeholder="{{translate('Ex: ABC Company')}}" tabindex="5">{{$address}}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file cmn_focus rounded">
                                    <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input"
                                           accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" tabindex="7">
                                    <label class="custom-file-label"
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select id="country" name="country" class="form-control js-select2-custom" tabindex="8">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="time_zone" id="time_zone" data-maximum-selection-length="3" class="form-control js-select2-custom" tabindex="9">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="time_format" class="form-control js-select2-custom" tabindex="10">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="currency" class="form-control js-select2-custom" tabindex="11">
                                    ...
                                    <div class="form-control d-flex flex-column-2 cmn_focus rounded">
                                        <div class="custom-radio d-flex gap-2 align-items-center"
                                            ...
                                            <input type="radio" class=""
                                                   ...
                                                   id="projectViewNewProjectTypeRadio1" tabindex="12" {{(isset($config) && $config=='left')?'checked':''}}>
                                        ...
                                        <div class="custom-radio d-flex gap-2 align-items-center"
                                            ...
                                            <input type="radio" class=""
                                                   name="projectViewNewProjectTypeRadio"
                                                   id="projectViewNewProjectTypeRadio2" tabindex="13" {{(isset($config) && $config=='right')?'checked':''}}>
                                            <label class="media align-items-center mb-0"
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$footer_text}}" name="footer_text" class="form-control"
                                       placeholder="{{translate('Ex: Copyright@efood.com')}}" required tabindex="15">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$pagination_limit}}" min="0"
                                       name="pagination_limit" class="form-control" placeholder="{{translate('Ex: 10')}}" required tabindex="16">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="self_pickup" {{$sp == null || $sp == 0? '' : 'checked'}} id="self_pickup_btn" tabindex="17">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input readonly class="switcher_input" type="checkbox" name="delivery"  {{$del == null || $del == 0? '' : 'checked'}} id="delivery_btn" tabindex="18">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="toggle_veg_non_veg" {{$vnv_status == null || $vnv_status == 0? '' : 'checked'}} id="toggle_veg_non_veg" tabindex="19">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="dm_self_registration" {{$dm_status == null || $dm_status == 0? '' : 'checked'}} id="dm_self_registration" tabindex="20">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="guest_checkout" {{$guest_checkout == null || $guest_checkout == 0? '' : 'checked'}} id="guest_checkout" tabindex="21">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="google_map_status" {{$google_map_status == null || $google_map_status == 0? '' : 'checked'}} id="google_map_status" tabindex="22">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="partial_payment" {{$partial_payment == null || $partial_payment == 0? '' : 'checked'}} id="partial_payment" tabindex="23">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="partial_payment_combine_with" class="form-control" tabindex="24">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control cmn_focus rounded d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="admin_order_notification" {{$admin_order_notification == null || $admin_order_notification == 0? '' : 'checked'}} id="admin_order_notification" tabindex="26">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="form-control cmn_focus rounded d-flex flex-column-2">
                                        <div class="custom-radio d-flex gap-2 align-items-center">
                                            <input type="radio" class=""
                                                   ...
                                                   id="admin_order_notification_type1" tabindex="26" {{(isset($admin_order_notification_type) && $admin_order_notification_type=='manual')?'checked':''}}>
                                            <label class="media align-items-center mb-0"
                                        ...
                                        <div class="custom-radio d-flex gap-2 align-items-center">
                                            <input type="radio" class=""
                                                   value="firebase"
                                                   name="admin_order_notification_type"
                                                   id="admin_order_notification_type2" tabindex="27" {{(isset($admin_order_notification_type) && $admin_order_notification_type=='firebase')?'checked':''}}>
                                            <label class="media align-items-center mb-0"
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$footer_text}}" name="footer_description_text" class="form-control"
                                       placeholder="{{translate('Ex: description')}}" required tabindex="28">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="btn--container mt-4">
                <button type="reset" class="btn btn-secondary" tabindex="29">{{translate('reset')}}</button>
                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                        class="btn btn-primary call-demo" tabindex="30">{{translate('submit')}}</button>
            </div>
        </form>
