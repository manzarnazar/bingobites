                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$branch['name']}}" type="text" name="name" class="form-control" maxlength="255"
                                               placeholder="{{translate('New branch')}}" tabindex="1" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label" for="">{{translate('address')}}</label>
                                        <input value="{{$branch['address']}}" type="text" name="address" class="form-control" placeholder="" required tabindex="2">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $branch['preparation_time'] }}" type="number" name="preparation_time" class="form-control"
                                               placeholder=" Ex: {{ translate('30') }}" min="1" required tabindex="3">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file cmn_focus rounded">
                                                <input type="file" name="image" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" class="upload-file__input" tabindex="4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$branch['phone']}}" type="tel" name="phone" class="form-control"
                                               placeholder="{{translate('Ex: +098538534')}}" required tabindex="5">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$branch['email']}}" type="email" name="email" class="form-control" maxlength="255"
                                               placeholder="{{translate('EX : example@example.com')}}" required tabindex="6">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="text" id="latitude" name="latitude" class="form-control"
                                                           ...
                                                           value="{{ $branch['latitude'] }}" required tabindex="8">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="text" name="longitude" class="form-control"
                                                           ...
                                                           value="{{ $branch['longitude'] }}" required tabindex="9">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="number" name="coverage" min="1" max="1000" class="form-control" placeholder="{{ translate('Ex : 3') }}" value="{{ $branch['coverage'] }}" required tabindex="10">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-md-6 position-relative" id="location_map_div">
                                        <input id="pac-input" class="controls rounded position-absolute left-0 top-0 z-index-2 mt-1 mx-3" data-toggle="tooltip"
                                               data-placement="right"
                                               data-original-title="{{ translate('search_your_location_here') }}"
                                               type="text" tabindex="11" placeholder="{{ translate('search_here') }}" />
