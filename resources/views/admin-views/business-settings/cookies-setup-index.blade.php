                                ...
                                <form action="{{route('admin.business-settings.restaurant.cookies-setup-update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex cmn_focus rounded-pill">
                                            <input type="checkbox" name="status" value="1" class="toggle-switch-input" tabindex="1" {{$cookies?($cookies['status']==1?'checked':''):''}}>
                                    ...
                                    <div class="form-group pt-3">
                                        <textarea name="text" class="form-control" rows="6" placeholder="{{ translate('Cookies text') }}" tabindex="2" required>{{$cookies['text']}}</textarea>
                                    </div>
                                    <div class="btn--container justify-content-end">
                                        <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                                class="btn btn-primary call-demo" tabindex="3">{{translate('save')}}</button>
                                    </div>
