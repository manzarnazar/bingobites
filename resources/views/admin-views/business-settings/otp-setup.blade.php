                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$maximumOTPHit}}" min="1"
                                               name="maximum_otp_hit" class="form-control" required tabindex="1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$OTPResendTime}}" min="1"
                                               name="otp_resend_time" class="form-control" required tabindex="2">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$temporaryBlockTime}}" min="1"
                                               name="temporary_block_time" class="form-control" required tabindex="3">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$maximumLoginHit}}" min="1"
                                               name="maximum_login_hit" class="form-control" required tabindex="4">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$temporaryLoginBlockTime}}" min="1"
                                               name="temporary_login_block_time" class="form-control" required tabindex="5">
                                    </div>
                                </div>
                            </div>

                            <div class="btn--container mt-4">
                                <button type="reset" class="btn btn-secondary" tabindex="6">{{translate('reset')}}</button>
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        class="btn btn-primary call-demo" tabindex="7">{{translate('submit')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
