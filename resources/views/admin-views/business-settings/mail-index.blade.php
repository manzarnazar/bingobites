                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center gap-3">
                            <button class="btn btn-secondary onfocus-btn cmn_focus-shadow" type="button" tabindex="1" data-toggle="collapse"
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="flex-grow-1">
                                            ...
                                            <input type="email" id="test-email" class="form-control"
                                                    placeholder="{{translate('Ex : jhon@email.com')}}" tabindex="2">
                                        </div>
                                        <button type="button" class="btn btn-primary send-mail" tabindex="3">
                                            <i class="tio-telegram"></i>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap mb-3">
                                    ...
                                    <div class="custom--switch cmn_focus rounded-pill">
                                        ...
                                        <label for="smtp-mail" data-on-label="on" data-off-label="off" tabindex="4"></label>
                                    </div>
                                </div>
                                <div class="row g-2">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" placeholder="{{translate('ex : Alex')}}" class="form-control" name="name"
                                            value="{{env('APP_MODE')!='demo'?$data['name']:''}}" required tabindex="3">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('host')}}</label>
                                        <input type="text" class="form-control" name="host" value="{{env('APP_MODE')!='demo'?$data['host']:''}}" required tabindex="5">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('driver')}}</label>
                                        <input type="text" class="form-control" name="driver" value="{{env('APP_MODE')!='demo'?$data['driver']:''}}" required tabindex="6"> 
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('port')}}</label>
                                        <input type="text" class="form-control" name="port" value="{{env('APP_MODE')!='demo'?$data['port']:''}}" required tabindex="7">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('username')}}</label>
                                        <input type="text" placeholder="{{translate('ex : ex@yahoo.com')}}" class="form-control" name="username"
                                            value="{{env('APP_MODE')!='demo'?$data['username']:''}}" required tabindex="8">
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" placeholder="{{translate('ex : ex@yahoo.com')}}" class="form-control" name="email"
                                            value="{{env('APP_MODE')!='demo'?$data['email_id']:''}}" required tabindex="9">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('encryption')}}</label>
                                        <input type="text" placeholder="{{translate('ex : tls')}}" class="form-control" name="encryption"
                                            value="{{env('APP_MODE')!='demo'?$data['encryption']:''}}" required tabindex="10">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>{{translate('password')}}</label>
                                        <input type="text" class="form-control" name="password" value="{{env('APP_MODE')!='demo'?$data['password']:''}}" required tabindex="11">
                                    </div>
                                </div>
                                <div class="btn--container mt-3">
                                    <button type="reset" class="btn btn-secondary" tabindex="12">{{translate('reset')}}</button>
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            class="btn btn-primary call-demo" tabindex="13">{{translate('save')}}</button>
                                </div>
                            @else
                                <button type="submit" class="btn btn-primary" tabindex="14">{{translate('configure')}}</button>
                            @endif
                        </div>
                    </div>
                </form>
