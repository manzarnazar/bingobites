                        ...
                        <form action="{{route('admin.business-settings.update-fcm-messages')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="row">
                                    ...
                                    @php($editOrderMessage= \App\Model\BusinessSetting::with('translations')->where(['key' => 'order_edit_message'])->first())
                                    @php($editOrderMessageData= json_decode($editOrderMessage?->value, true))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <label class="switcher" for="edit_status">
                                                    <input type="checkbox" name="edit_status" class="switcher_input"
                                                           value="1" id="edit_status" {{(isset($editOrderMessageData['status']) && $editOrderMessageData['status']==1)?'checked':''}}>
                                                    <span class="switcher_control"></span>
                                                </label>
                                                <span class="text-dark">{{translate('edit_status_message')}}</span>
                                            </div>

                                            <textarea name="edit_message" class="form-control">{{$editOrderMessageData['message']??''}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
