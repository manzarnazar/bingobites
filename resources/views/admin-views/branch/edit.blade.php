                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $branch['preparation_time'] }}" type="number" name="preparation_time" class="form-control"
                                                       placeholder=" Ex: {{ translate('30') }}" min="1" required tabindex="6">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="number" step="any" id="latitude" name="latitude" class="form-control"
                                                           ...
                                                           value="{{ $branch['latitude'] }}" required  tabindex="9">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="number" step="any" name="longitude" class="form-control"
                                                           ...
                                                           value="{{ $branch['longitude'] }}" required tabindex="10">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="number" name="coverage" min="1" max="1000" class="form-control" placeholder="{{ translate('Ex : 3') }}" value="{{ $branch['coverage'] }}" required tabindex="11">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 position-relative" id="location_map_div">
                                        <input id="pac-input" class="controls rounded position-absolute z-index-2 top-0 left-0 m-2 z-1" data-toggle="tooltip"
