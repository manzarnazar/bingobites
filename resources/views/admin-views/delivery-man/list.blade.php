                ...
                <form action="{{ url()->current() }}" method="GET" id="search-form">
                    ...
                    <div class="d-flex gap-4 justify-content-between align-items-end flex-wrap">
                        <div class="form-group flex-grow-1 mb-0">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" name="date" id="js-daterangepicker-predefined" class="form-control"
                                    placeholder="{{ translate('Select Date') }}" value="{{ request()->get('date') }}" autocomplete="off" tabindex="1">
                        ...
                        <div class="form-group flex-grow-1 mb-0">
                            ...
                            <select class="custom-select" name="status" id="status" tabindex="2">
                        ...
                        <button type="submit" class="btn btn-primary px-6" tabindex="3">{{ translate('filter') }}</button>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <form action="{{ url()->current() }}" method="GET" class="flex-grow-1" id="searchForm">
                                ...
                                <div class="input-group">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        ...
                                        aria-label="Search" value="{{ $search }}" autocomplete="off" tabindex="4">
                            ...
                            <div class="d-flex flex-wrap justify-content-end gap-3">
                                <div>
                                    <button type="button" class="btn btn-outline-primary text-nowrap px--12px"
                                        data-toggle="dropdown" aria-expanded="false" tabindex="6">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a type="submit" class="dropdown-item cmn_focus d-flex align-items-center gap-2"
                                ...
                                <a href="{{ route('admin.delivery-man.add') }}" class="btn cmn_focus btn-primary px--12px" tabindex="8">
                                    <i class="tio-add"></i>
