                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="{{translate('New banner')}}" tabindex="1" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file cmn_focus rounded">
                                                <input type="file" name="image" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" class="upload-file__input" tabindex="5">
