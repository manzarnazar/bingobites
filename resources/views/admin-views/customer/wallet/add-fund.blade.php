                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select id='customer' name="customer_id" data-placeholder="{{translate('Select_Customer')}}" class="js-data-example-ajax form-control h--45px cmn_focus" tabindex="1" required>
                                    <option value="">
                                        sadfdf
                                    </option>
                                </select>
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control h--45px" name="amount" id="amount" step=".01" tabindex="2" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="referance">{{translate('reference')}} <small>({{translate('optional')}})</small></label>
                                <input type="text" class="form-control h--45px" name="referance" id="referance" tabindex="3">
                            </div>
                        </div>
                    </div>
                    <div class="btn--container justify-content-end">
                        <button type="reset" id="reset" class="btn btn-secondary" tabindex="4">{{translate('reset')}}</button>
                        <button type="submit" id="submit" class="btn btn-primary" tabindex="5">{{translate('submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
