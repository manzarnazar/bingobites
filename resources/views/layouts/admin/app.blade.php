...
<head>
    ...
    {{-- country picker --}}
    <link rel="stylesheet" href="{{ asset('assets/admin/vendor/intl-tel-input/css/intlTelInput.css') }}" />
    {{--Carousel Slider--}}
...
<script src="{{asset('assets/admin')}}/vendor/intl-tel-input/js/intlTelInput.js"></script>
<script src="{{asset('assets/admin')}}/vendor/intl-tel-input/js/utils.js"></script>
<script src="{{asset('assets/admin')}}/vendor/intl-tel-input/js/intlTelInout-validation.js"></script>
