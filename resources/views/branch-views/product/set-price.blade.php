    ...
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="set_price_form" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="card p-4" id="">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" value="{{$product['name']}}" class="form-control" placeholder="{{translate('Product Name')}}" readonly required tabindex="1">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="stock_type" class="form-control js-select2-custom" id="stock_type" tabindex="2">
                                ...
                                <div class="col-sm-6 d-none" id="product_stock_div">
                                    <div class="form-group">
                                        ...
                                        <input id="product_stock" type="number" name="product_stock" class="form-control"
                                               value="{{ $stock}}" placeholder="{{translate('Ex : 10')}}" tabindex="3">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-sm-3 gap-1 flex-sm-nowrap flex-wrap">
                                    ...
                                    <div class="d-flex gap-3 align-items-center">
                                        ...
                                        <label class="switcher cmn_focus rounded-pill">
                                            ...
                                            <input class="switcher_input" type="checkbox" name="halal_status" tabindex="4" {{ $product->sub_branch_product?->halal_status == 1 ? "checked" : '' }}>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $price }}" min="0.1" name="price" class="form-control" step="0.01"
                                               placeholder="{{translate('Ex : 100')}}" required tabindex="5">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="input-label">{{translate('discount_Type')}}</label>
                                        <select name="discount_type" class="form-control js-select2-custom" tabindex="6">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" value="{{$discount}}"
                                               name="discount" class="form-control" required placeholder="Ex : 100" tabindex="7">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                <button type="reset" class="btn btn-secondary" tabindex="8">{{translate('reset')}}</button>
                <button type="submit" class="btn btn-primary" tabindex="9">{{translate('update')}}</button>
            </div>
        </form>
    </div>
