...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::get('edit/{id}', [OrderController::class, 'editOrder'])->name('edit');
            Route::post('addProductToSession', [OrderController::class, 'addProductToSession'])->name('addProductToSession');
            Route::get('product/variation', [OrderController::class, 'loadVariationModal'])->name('product.variation');
        ...
        Route::group(['prefix' => 'ai-settings', 'as' => 'ai-settings.', 'middleware' => ['module:system_management']], function () {
            Route::get('configuration', [AISettingsController::class, 'AIConfigurationIndex'])->name('configuration');
            Route::post('update', [AISettingsController::class, 'AIConfigurationUpdate'])->name('update');
        });
